...
contract('Verifier', accounts => {
    ...
    it('should to be true the correct proof and emit event', async() => {
    ...
    it('should to be false the  incorrect proof and not emit event', async() => {
        let tx = await contractInstance.verifyTx(
            proofAsUint.proof.A,
            proofAsUint.proof.A_p,
            proofAsUint.proof.B,
    ...
    it('should to be false the incorrect proof for the input and not emit event', async() => {
        let tx = await contractInstance.verifyTx(
            proofAsUint.proof.A,
            proofAsUint.proof.A_p,
            proofAsUint.proof.B,
